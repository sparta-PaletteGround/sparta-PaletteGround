...
6. supabase를 활용하여 CRUD를 해보고 firebase와는 어떤 차이점이 있는지 생각해 보는 기회가 되었다.
7. 한 컴포넌트에 여러 개의 useQuery들을 작성하게 되면 이들이 비동기로 작동하기에 문제가 생길 수도 있음을 알게 되었다.
8. 브랜치 관리, PR 과정, 머지 방식 등 github 협업 전반에 대한 이해도가 이전보다 높아졌다.

<소통 예시>
|                                                           |                                                        |
| --------------------------------------------------------- | ------------------------------------------------------ |
| <img width="619" alt="스크린샷 2024-03-25 오후 2 38 16" src="https://github.com/sparta-PaletteGround/sparta-PaletteGround/assets/154870548/d8f05f79-bf5b-429b-92d6-0e64791660e1"> | <img width="703" alt="스크린샷 2024-03-25 오후 2 40 10" src="https://github.com/sparta-PaletteGround/sparta-PaletteGround/assets/154870548/bcef0561-107c-49b5-9c9a-37f3c522ed38"> |
